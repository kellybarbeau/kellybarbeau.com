...
window.TRAVEL_DATA = {
  ...
  itineraries: [
    ...
    {
      slug: "montreal-tom-kelly",
      name: "Montréal — Tom & Kelly Weekend",
      location: "Canada",
      duration: "4 days",
      gradient: 5,
      intro: "Brunch-heavy long weekend with a few dinners and the requisite walk through the Plateau.",
      days: [
        {
          label: "Thursday",
          items: [
            "Sleep at Mike's parents'"
          ]
        },
        {
          label: "Friday",
          items: [
            "Brunch at Sparrow — for the memories",
            "Shop around St-Laurent + beers at Dieu du Ciel",
            "Petit Dépôt Christmas thing / shops / Frank & Oak / St-Viateur",
            "Airbnb check-in",
            "7:45pm — Dinner at Kitano Shokudo",
            "Bars: Darling, La Buvette, Bar à Flot",
            "Drinks in the Plateau / potential show @ NCG"
          ]
        },
        {
          label: "Saturday",
          items: [
            "Crew Café coffee",
            "Brunch at Dandy (walk-in)",
            "8pm — Dinner with Eric & Lindsay at Liverpool House",
            "Meet up with Steph & JP for drinks TBD"
          ]
        },
        {
          label: "Sunday",
          items: [
            "10:30am — Brunch at Passé Composé"
          ]
        }
      ]
    },
    ...
    {
      slug: "montreal-friends",
      name: "Montréal — Les Friends",
      location: "Canada",
      duration: "April 10–13",
      gradient: 5,
      intro: "Four days with friends visiting — coffees, walks along the Lachine Canal, and dinners at Rita and Damas.",
      days: [
        {
          label: "Thursday, April 10",
          items: [
            "✈️ Cole and Lucy land — AM",
            "✈️ Tom and Kelly land — Evening"
          ]
        },
        {
          label: "Friday, April 11",
          items: [
            "☕️ Justine and Mike demonstrate their espresso making skills",
            "🥞 Brunch at Millman's",
            "🚶‍♀️ Walk along Lachine Canal (weather permitting) — Messorem, Memento breweries",
            "Alts: bowling? escape room?",
            "🍣 Saint Sushi Snack at home (for Kelly)",
            "🥂 Apéro at our place",
            "🍝 7:30 dinner at Rita",
            "🍹🃏 Bar Courcelle or Bar Bon Délire after / games at home"
          ]
        },
        {
          label: "Saturday, April 12",
          items: [
            "☕️ Coffees and walk in Westmount",
            "🍟 Mont Royal / Plateau + Patati Patata lunch",
            "🎶 Drinks at Bar Le Record",
            "🧆 9:30 dinner at Damas"
          ]
        },
        {
          label: "Sunday, April 13",
          items: [
            "🥞 Brunch and coffees at home — Steph / JP will join",
            "🤗 Hang out",
            "✈️ Friends depart — PM"
          ]
        }
